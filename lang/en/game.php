...
$string['completiondetail_pass'] = 'Receive a passing grade';
$string['completionattemptsexhausted'] = 'Or all available attempts completed';
$string['completionattemptsexhausted_help'] = 'Completion status when all available attempts are exhausted';
$string['completiondetail_attemptsexhausted'] = 'Complete all available attempts';
