...
class mod_game_mod_form extends moodleform_mod {
    ...
    public function add_completion_rules() {
        ...
        $mform->addElement('advcheckbox', $completionpassel, '', get_string('completionpass', 'game'));
        $mform->addHelpButton($completionpassel, 'completionpass', 'game');
        $mform->disabledIf($completionpassel, 'completionusegrade' . $suffix, 'notchecked');
        $items[] = $completionpassel;

        $completionattemptsexhaustedel = 'completionattemptsexhausted' . $suffix;
        $mform->addElement('advcheckbox', $completionattemptsexhaustedel, '', 
                get_string('completionattemptsexhausted', 'game'));
        $mform->addHelpButton($completionattemptsexhaustedel, 'completionattemptsexhausted', 'game');
    ...
    public function completion_rule_enabled($data) {
        $suffix = $this->get_suffix();
        return !empty($data['completionattemptsexhausted' . $suffix]) || !empty($data['completionpass' . $suffix]);
    }
}
